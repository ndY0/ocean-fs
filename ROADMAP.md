...
- audit for performance improvment on the critical path
- lots of networking : brainstorm network optimisations : batching, compression, load/dc aware router optimisation, maybe introduce network topologies ?
